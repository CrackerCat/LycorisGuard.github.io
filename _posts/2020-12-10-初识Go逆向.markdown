...
![1](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/1.png)

直接查看字符串没有"Hello, World!"

使用[go_parser](https://github.com/0xjiayu/go_parser/blob/master/README_cn.md)插件就可以在字符串窗口看到我们的"Hello, World!"

![2](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/2.png)

查看汇编代码，直接通过堆栈赋值传递，并且IDA解析没有解析到这个参数

![3](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/3.png)
...
![4](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/4.png)

### 二、实战下go实现注入

参考

[w32](https://github.com/JamesHovious/w32)

[go-win32-inject-tool](https://github.com/godtoy/go-win32-inject-tool)
...
![5](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/5.png)

![6](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/6.png)

redress命令行： 

![7](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/7.png)

使用redress查看go结构体

![8](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/8.png)

查看go的pkg

![9](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/9.png)

查看go源码

![10](https://raw.githubusercontent.com/LycorisGuard/BlogPic/master/2020-12-10/10.png)

---
layout: post
title: Windows ETW 学习与使用二
date: 2020-10-24 10:56:12 +0900
category: windows
---
## 一、枚举ETW

[EnumerateTraceGuidsEx](https://docs.microsoft.com/en-us/windows/win32/api/evntrace/nf-evntrace-enumeratetraceguidsex) 来枚举Providers 的注册者的相关ETW的注册信息
...
### 2.1 [StopTrace](https://docs.microsoft.com/en-us/windows/win32/api/evntrace/nf-evntrace-stoptracew)

```cpp
        status = StopTraceW(SessionHandle, LOGSESSION_NAME, pSessionProperties);
        if (ERROR_SUCCESS != status)
        {
            wprintf(L"StopTraceW(stop) failed with %lu\n", status);
        }
```

### 2.2 [ControlTrace](https://docs.microsoft.com/en-us/windows/win32/api/evntrace/nf-evntrace-controltracew)传入EVENT_TRACE_CONTROL_STOP
...
### 2.3 [EnableTraceEx2](https://docs.microsoft.com/en-us/windows/win32/api/evntrace/nf-evntrace-enabletraceex2)传入EVENT_CONTROL_CODE_DISABLE_PROVIDER
...
## 三、使用logman query providers指令查询系统的providers

```cpp
Microsoft Windows [版本 10.0.18362.1139]
(c) 2019 Microsoft Corporation。保留所有权利。

C:\Users\Administrator>logman query providers
...
Intel Usb3 Hub                           {3E06C48C-348A-444B-8727-F119487638C9}
Intel Usb3 xHC                           {11305155-8C71-4396-97A0-CAEAEC0A12BD}
Intel-GFX-Info                           {F70D4BE7-78E4-4EDF-91A9-0C1341D500DB}
...
Intel-SST-CFD-HDA                        {DAAE058C-46C9-4C13-85D9-D352FD829951}
...
LocationNotifications                    {5B93CDFA-5F51-45E0-9FDE-296983129E6C}
...
Microsoft-IEDVTOOL                       {7DE899B6-DE3F-4892-BF66-0A8739BA939B}
...
Microsoft-Windows-AltTab                 {11A377E3-BE1E-4EE7-ABDA-81C6EDA62E71}
Microsoft-Windows-API-Tracing            {B98F0DB6-26E2-4A66-89FC-32A9A6A9AF61}
...
Microsoft-Windows-BdeTriggerProvider     {9E6AE157-D9F7-47E5-8C6D-B17BB6C82A27}
...
Microsoft-Windows-CEIP                   {A402FE09-DA6E-45F2-82AF-3CB37170EE0C}
...
Microsoft-Windows-Dhcp-Nap-Enforcement-Client {F6DA35CE-D312-41C8-9828-5A2E173C91B6}
...
Microsoft-Windows-Diagnosis-TaskManager  {B03D4051-3564-4E93-93DB-3C34F1B5B503}
...
Microsoft-Windows-DriverFrameworks-KernelMode {1A3C3605-AA85-4B19-AA24-BB74BC365059}
...
Microsoft-Windows-EFSTriggerProvider     {6863E644-DD5D-43A2-A8B5-7A81B46672E6}
...
Microsoft-Windows-EnhancedStorage-EhStorCertDrv {BD2D1DAE-D678-4E10-9667-21CBA2AA70C3}
...
Microsoft-Windows-Eqos-SQM-Provider      {65D341F3-BAAA-4C6E-8B20-23D4F1574004}
...
Microsoft-Windows-EtwCollector           {9E5F9046-43C6-4F62-BA13-7B19896253FF}
...
Microsoft-Windows-GettingStarted         {F557ACE2-BCF8-4994-8E4B-42368A6F078A}
...
Microsoft-Windows-HotStart               {7BB5AF18-CB16-4007-B813-9D88E9D6F8EF}
...
Microsoft-Windows-IPBusEnum              {CD032E15-15AD-4DA4-AFC6-03BF83516195}
...
Microsoft-Windows-MCT                    {EB3DEB18-D1DE-4897-8502-A230AD03DB8A}
Microsoft-Windows-Media Center Extender  {7B7838A3-6562-4269-BB7A-97B0D9593882}
...
Microsoft-Windows-MSMQ                   {CE18AF71-5EFD-4F5A-9BD5-635E34632F69}
Microsoft-Windows-MSMQTriggers           {2787CC62-2654-4227-9B35-B53F838507AE}
Microsoft-Windows-MSPaint                {1D75856D-36A7-4ECB-A3F5-B13152222D29}
Microsoft-Windows-MUI                    {A8A1F2F6-A13A-45E9-B1FE-3419569E5EF2}
Microsoft-Windows-NAPIPSecEnf            {8115579E-2BEA-4C9E-9AB1-821CC2C98AB0}
...
Microsoft-Windows-NetworkAccessProtection {4EF850D8-BF30-4E64-A917-EE21B9BE1F0A}
...
Microsoft-Windows-OcSetup                {AAF44901-5C64-4014-8B6C-A80813937293}
...
Microsoft-Windows-OOBE-Machine           {DF32A572-0B4B-44BE-B09B-72084FDBF879}
...
Microsoft-Windows-PeopleNearMe           {8085CB91-900E-4D15-A7D1-921DDCE641D8}
...
Microsoft-Windows-Recovery               {9E95E4D0-4CB4-4B5D-A936-C972D7D08D90}
...
Microsoft-Windows-Reliability-Analysis-Engine {4BA32972-6FC5-488A-8368-5DA620D05127}
...
Microsoft-Windows-RemoteDesktopServices-RemoteDesktopSessionManager {7BFCF102-7378-431C-9284-0B968258991A}
...
Microsoft-Windows-Remotefs-UTProvider    {588CD2E4-A5B0-492D-A59B-F6DD3E7681C6}
...
Microsoft-Windows-Resource-Leak-Diagnostic {5C9BE3E0-3593-4DCD-8F6D-63840923FFEE}
...
Microsoft-Windows-Service Pack Installer {62EF8B9F-EE45-4ABA-A9B9-B70E878BF30A}
...
Microsoft-Windows-Sidebar                {ED6B3BA8-95B2-4CF5-A317-D4AF7003884C}
...
Microsoft-Windows-SpoolerTCPMon          {CAD2D809-03D9-4F46-9CF4-72AA4F04B6B9}
...
Microsoft-Windows-StickyNotes            {EE4F43B5-03EB-41D2-A28C-BA8BEE529247}
...
Microsoft-Windows-SystemHealthAgent      {B1BEBB9A-24AA-4B83-9E4A-38C2A9A44377}
...
Microsoft-Windows-TerminalServices-MediaRedirection-DShow {B1C94ED9-AC9B-410E-AA48-4FFC5E45F4E3}
...
Microsoft-Windows-WMPDMCCore             {67BD1FEF-AFB2-458D-BCDE-3758BEB84DEC}
...
Microsoft-Windows-WWAN-UI-EVENTS         {78168022-ECA5-41E8-9E17-E8C7FD77AAE1}
...
MSMQ: AC                                 {322E0B22-0527-456E-A5EF-E5B591046A63}
MSMQ: DS                                 {5DC62C8C-BDF2-45A1-A06F-0C38CD5AF627}
MSMQ: ERRORLOGGING                       {F707F440-AD58-47F8-93D3-BEA2F9E82FD2}
MSMQ: General                            {45033C79-EA31-4776-9BCD-94DB89AF3149}
MSMQ: Log                                {A13EC7BB-D592-4B93-80DA-C783F9708BD4}
MSMQ: Networking                         {6E2C0612-BCF3-4028-8FF2-C60C288F1AF3}
MSMQ: Profiling                          {71625F6D-559A-49C6-BA21-0AEB260DB97B}
MSMQ: Routing                            {8753D150-950B-4774-AC14-9C6CBFF56A50}
MSMQ: RPC                                {F8354C74-DE9F-48A5-8139-4ED1E9F20A1B}
MSMQ: Security                           {90E950BB-6ACE-4676-98E0-F6CDC1403670}
MSMQ: SRMP                               {DA1AF236-FAD6-4DA6-BD94-46395D8A3CF5}
MSMQ: XACT_General                       {8FDA2BBD-347E-493C-B7D1-6B6FED88CE04}
MSMQ: XACT_Log                           {1AC9B316-5B4E-4BBD-A2C9-1E70967A6FE1}
MSMQ: XACT_Receive                       {7C916009-CF80-408B-9D91-9C2960118BE9}
MSMQ: XACT_Send                          {485C37B0-9A15-4A2E-82E0-8E8C3A7B8234}
MUI Resource Trace                       {D3DE60B2-A663-45D5-9826-A0A5949D2CB0}
Multi-FrameRate                          {2B25961D-BA6E-4D79-BEC7-3605366E2E09}
Multi-Input                              {70E2503B-C6F3-4780-B323-BD8ED0C61BF8}
Multi-Main                               {231CF54B-22A0-49E4-A59A-47052A30FFED}
Multi-Worker                             {E9C3DA11-E2A5-48FD-9CD3-17E7C764D303}
...
TeeDriver                                {E1DA8995-85BC-452B-B62B-0913306A430E}
...
对于微软的Providers的格式，我们可以参考这个链接

[https://github.com/jdu2600/Windows10EtwEvents/tree/04f4f5287c35795f172fefe768124f5ee7e9df28/manifest](https://github.com/jdu2600/Windows10EtwEvents/tree/04f4f5287c35795f172fefe768124f5ee7e9df28/manifest)
